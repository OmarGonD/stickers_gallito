...
urlpatterns = [
    ...
    path('muestras/<slug:product_slug>/medida-y-cantidad', views.StepOneView_Sample.as_view(), name='SampleDetail'),
    path('muestras/<slug:product_slug>/subir-arte', views.StepTwoView_Sample.as_view(), name='UploadArt'),
